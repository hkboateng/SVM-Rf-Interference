...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec  7 23:43:46 2019
...
class ARPSimulator:
    ...
    def generateFreqEnergy(self,lambda1, lambda2, numberOfSamples,powerLvl):
        ...
        while totalTime < N:
            ...
            if seqState:
                ...
                if upDist=="exp":
                    ...
                    trueSig = m.sqrt(np.log((1/var1)/((1/lambda1)**2)+1))
        ...
        traffic_intensity = np.mean(occupancy) #measures traffic intensity
        ...
        #predPwrStates = pwrStates[:,500+1+N_train:N];
        #observed accuracy
        obsAccA = np.sum(obsState[0:dLen:dLen*N-dLen+1]==occSwitch) /dLen*N-dLen+1
        xfactor = dLen*N-dLen+1
        dAccS = np.sum(obsState[0:dLen*N-dLen+1]==occSwitch[0:dLen*N-dLen+1]);
        dAcc = dAccS/xfactor
...
#arp = ARPSimulator()
#numOfSamples =1000
#obsState,occSwitch,snr,dAcc = arp.generateFreqEnergy(0.2,0.2,numOfSamples,-65)
