...
#t1 = time.time()
#arp = ARP_Simulator()
#vectFunc = np.vectorize(arp.arpSimulatorGenerator,otypes=[np.float],cache=True)
#snr_svm_accuracy_list=vectFunc(lambdaList,lambdaList,powerLvlList)
#
#t2 = time.time()
#print((t2-t1)/60)
#a=snr_svm_accuracy_list[5]
...
plt.savefig("accuracy_cumulants_convention_01_30_2020.png")
#plt.subplot(212)
