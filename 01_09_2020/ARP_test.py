...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 14 21:33:16 2020
...
def calc_array_trueState_1r(ambState,trueState,checkVal,numberOfSamples):
...
N_test = dLen*N//2;
N = N_train+N_test;
powerLvl = -50 #power in dBm
lambda1 = 0.2 #arrival rate per sample
lambda2 = 0.2 #survival rate per sample
...
if isCumulants:
    ...
    threshold = 1 * thresh  
svmp.plotSVM(inputPwr,prediction,numberOfSamples,threshold,False)
...
rSize_2 =calc_array_trueState_1r(ambState,trueState,1,N)

countReturns = countReturns(rSize_1,rSize_2)

cal_predStep_0 = calc_array_obj_test(ambState,predState_lstep,0)
cal_trueState_1r_0 = calc_array_obj_test(ambState,trueState_1r,0)
